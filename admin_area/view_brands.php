<h3 class="text-center text-center">All Brands</h3>
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        ?>
            ...
            <!-- putting up code to be included -->
        <?php
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer bg-light">
            <button type="button" class="btn btn-secondary" data-dismiss="modal"><a href="./index.php?view_brands" class="
            text-light text-decoration-none">No</a></button>
